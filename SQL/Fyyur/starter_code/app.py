...
] = "postgresql://postgres:postgres@localhost:5432/fyur"
app.config["SQLALCHEMY_TRACK_MODIFICATIONS"] = False
db = SQLAlchemy(app)
migrate = Migrate(app, db)  # initial migration complete, psql databse populated.

# TODO: connect to a local postgresql database
# Connected using app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:postgres@localhost:5432/fyur'
...
class Venue(db.Model):
    ...
    # Updated to include missing fields and migrated/upgraded.
